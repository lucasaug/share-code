...
<html>
	...
	<body>
		...
		<div id="conteudo">
		    <h2 id="nome" class="inline">TheShadowLight</h2>
		    <span class="input">
		    	<span class="tipo">
		    ...
		    <div id="pessoal" class="lefted">
		    	<h4>Nome:&nbsp;
		    		<span id="usuario">Raphael Esteves Motta</span>
		    		<span class="input">
		    			<span class="tipo">
		    ...
		    <div id="contato" class="lefted">
		    	<h4>Email:&nbsp;
		    		<a href="mailto:raphaestmtt@gmail.com" id="email">raphaestmtt@gmail.com</a>
		    		<span class="input">
		    			<span class="tipo">
