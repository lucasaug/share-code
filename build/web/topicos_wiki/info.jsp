...
<html>
	<head>
		<title>Informa&ccedil;&otilde;es Gerais - ShareCode</title>
	...
	<body>		
		...
		<div id="conteudo">
			...
			<div id="topico">
				<h2 id="tituloTopico">Informa&ccedil;&otilde;es Gerais</h2>
					<h5 id="conteudoTopico">
						<ul>
							<li>Administrador do site: Lucas Augusto (lucasaug)</li>
						</ul>
					</h5>
